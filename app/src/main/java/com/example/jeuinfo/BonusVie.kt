...
class BonusVie(x1:Float, y1:Float, largeur:Float, hauteur:Float, vitesseX:Float, vitesseY:Float, image: Bitmap,son:Son) : Bonus(x1, y1, largeur, hauteur, vitesseX, vitesseY, image,son), CollisionDisparition {
